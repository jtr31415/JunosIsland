...
export const TURKEY_ASSEMBLY = defineCreature('animal-turkey', {
  ...
  flag: 'THE FAN IS THE ANIMAL AND ITS TWO NUMBERS ARE FORCED, SO LOOK AT IT FIRST. box-38 is '
    ...
    + 'cone-01 the hen stands three of on its crown, turned over by { axis: x, deg: 180 } and hung '
    ...
    + 'the hen\'s three points would stand at two different heights. box-41 IS THE OTHER HALF OF "BIGGEST" '
