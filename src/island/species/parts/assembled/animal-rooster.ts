...
export const ROOSTER_ASSEMBLY = defineCreature('animal-rooster', {
  ...
  flag: 'THIS ANIMAL IS animal-chicken WITH THREE THINGS ADDED AND IT IS MEANT TO BE — a cock and '
    ...
    + 'writing: the hen buries cone-01 at 8/16 and stands 0.200178 proud, this one omits sink '
    ...
    + 'THE STEP STAYS 2/16 AND THAT IS THE ONE NUMBER OF THE HEN\'S THAT DOES NOT INVERT: at this '
    + 'shallower burial the cone leaves the crown 0.225994 across rather than 0.164285 so 3/16 '
    + 'would overlap by 0.038494 and the hen\'s own rule would take it, but five points at 3/16 measure '
    ...
    + 'comb is SOLID for 0.123073 above the crown against the hen\'s 0.047873 — 2.571x — and then carries '
    ...
    + 'REFUSED ON THE HEN\'S OWN NUMBER: the hen measured that overruling the bunny-nose box\'s '
    + 'burial to 8/16 opens the hen\'s 0.108 window but leaves 0.039913 standing, 3.2% of the '
    + 'hull\'s width, and that was right — it is nothing. So the wattle is cone-01 AGAIN, turned upside down by '
    ...
    + 'leg it grows on. IT BOBS, AND THE HEN\'S REFUSAL IS NOT OVERTURNED: the hen declined bob '
    ...
    + 'separation from the hen is SATURATION AND VALUE, not hue — coat 0x93501e against the '
    + 'hen\'s 0xb5824a is 9.1 degrees of hue away at 91.5% saturation and 15.2% lightness against '
    + 'the hen\'s 74.2% and 26.5%, so the two read as obviously the same animal and not the same '
    + 'bird — plus sickle '
    + '0x1b3325, the darkest slot on any Farm animal. limb, foot and eye are THE HEN\'S unchanged, '
